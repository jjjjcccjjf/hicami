    ...
    return (
        <>
            <div className="bg-red-100 fixed h-full w-full top-0 left-0 -z-10">
                <FadeInSection>
                    <h1 className="text-[2.75rem] uppercase text-center scale-y-[3] pt-[1.8rem] scale-x-[2.9] px-0 md:text-[6.0rem] md:pt-[3.0rem] lg:pt-[3.75rem] lg:scale-x-[3.75] lg:scale-y-[3.75] xl:scale-y-[4] xl:scale-x-[4] xl:pt-[4rem] 2xl:scale-[5] 2xl:pt-[4.25rem]">Hicami</h1>
                </FadeInSection>
