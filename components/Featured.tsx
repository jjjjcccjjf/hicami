...
export default function Featured() {
    return (
        <>
            <section className="flex flex-col items-center justify-center bg-red-100 mt-[19rem] h-[34rem] md:mt-[31rem] md:h-[55rem]">
                {/* <div className="w-[33%] -translate-y-60"> */}
                <div className="w-5/6 -translate-y-20 md:-translate-y-[7rem]">
